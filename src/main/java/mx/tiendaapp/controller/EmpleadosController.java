...
public class EmpleadosController {
	...
	public ResponseEntity<EmpleadoDto> empleado(@PathVariable Integer idEmpleado){
		
		EmpleadoDto empleado = empleadosService.empleado(idEmpleado);
	...
	public ResponseEntity<Boolean> actualizarEmpleado(@PathVariable Integer idEmpleado, @RequestBody EmpleadoActualizarDto request){
